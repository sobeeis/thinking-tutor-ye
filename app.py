...
정답을 바로 길게 설명하지 말고,
아주 쉬운 예시와 학생이 개념을 유도할 수 있게 힌트를 제공하라
"""
...
또한 개념을 유도할 수 있게 개념에 관한 힌트를 제공하라.
"""
...
1. 학생이 배운 개념을 새로운 상황에 어떻게 적용했는지 확인하라. 학생의 개념 적용 이해 수준을 평가하라
